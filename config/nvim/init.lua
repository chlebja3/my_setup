  ...
  -- Autoformat
  {
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        -- Upstream kickstart switched this to a whitelist; we keep the original
        -- blacklist so every filetype still formats on save except the ones
        -- listed here, which is how this config has always behaved.
